...
header = ["DataType", "Label", "Plain Description", "Target", "Encoding"]
    ...
    if table:
        ...
        for row in rows[1:]:
            ...
            if code.isdigit() or code == ".":
                ...
                return
        df.loc[name] = {header[0]: datatype, header[1]: Label, header[2]: Plain_Description, header[3]: Target, header[4]: m}
    else:
